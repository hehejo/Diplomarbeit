...
Die Verbindung der Publish/Subscribe Methoden und den genutzten Methoden der KBR-API ist trivial: Jede verschickte Nachricht wird durch die Methoden \emph{forward} und \emph{deliver} des Netzwerkes verarbeitet.\\
