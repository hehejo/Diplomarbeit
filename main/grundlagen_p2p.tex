...
Netzwerke der dritten Generation, wie z.B. GNUnet \cite{Bennett2002GNet} werden in dieser Arbeit nicht näher betrachtet. Die zusätzlich angebotene Funktionalität wird nicht benötigt beziehungsweise liegt darauf kein Fokus. Die Authentifizerung von Clients im Spiel findet weiterhin durch einen dezdierten Server statt.\missing{Papa: Warum nicht? 3G ist doch besser als 2G!}\\
