...
Das leaf set enthält die $l$ numerisch nähsten Knoten, $frac{l}{2}$ davon sind kleiner und $frac{l}{2}$ größer als der aktuelle Knoten. Neben Informationen zu Routingentscheidungen kann es auch zur Reparatur genutzt werden, wenn nahegelegene Knoten ausfallen.
