...
\Fref{fig:can_key_space} zeigt einen zweidimensionalen Schlüsselraum von je 0 - 100 mit den drei Knoten A,B und C und fünf Daten. Der Schlüsselraum ist komplett auf die drei Knoten aufgeteilt, wobei A für den Bereich $(0,50)-(100,100)$, B für $(0,0)-(50,50)$ und C für $(50,0)-(100,50)$ zuständig ist.
