...
Publish/Subscribe-Systeme können als Anwendungsfall von \ac{cast} gesehen werden. Dies ist selbst eine Anwendung der generischen KBR-API\footnote{siehe \Fref{chap:evaluation_p2p:generic_api}}. Alle untersuchten Netzwerke genügen dieser und sind somit als Basis für \ac{cast} nutzbar.
...
\missing{Philipp:  vlt kannst noch schreiben, dass implementierungsspeziefische Details eigentlich nicht in die Entscheidung eingehen und du dich daher für das Prinzip von Pastry bzw. Tapestry entscheidest, oder eben Chimera.}
