...
\paragraph{Geringe Latenz} Schnelle Reaktionszeiten und Nachrichtenübermittlung sind bei \ac{mmog} unverzichtbar. Ebenfalls müssen größere Nachrichten (beispielsweise Update der Welt) schnell übertragen werden, damit der Spielfluss nicht behindert wird. Dies lässt sich bespielsweise anhand der Anzahl der Hops beim Nachrichtenversand messen.
...
Da die Größe des leaf set ebenfalls wählbar ist, können hier ebenfalls vermehrt nahe Knoten plaziert werden.
...
Der Austritt eines Knotens kann vom System wie ein Ausgefall behandelt werden. Um die Datenintegrität zu gewährleisten und um unnötigen Nachrichtenversand im System zu vermeiden, ist es nützlich den Austritt eines Knotens speziell zu behandeln.
